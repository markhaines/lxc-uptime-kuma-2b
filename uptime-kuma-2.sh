...
# Specify the desired version instead of fetching the latest
DESIRED_VERSION="2.0.0-beta.0"
...
msg_info "Pulling ${APP} ${DESIRED_VERSION}"
git fetch --all &>/dev/null
git checkout $DESIRED_VERSION --force &>/dev/null
msg_ok "Pulled ${APP} ${DESIRED_VERSION}"

msg_info "Updating ${APP} to ${DESIRED_VERSION}"
